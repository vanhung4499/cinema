  ...
  <div>
    ...
    <div class="board">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item>Carousel Information</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    ...
    <el-card class="box-card">
      ...
      <el-row :gutter="20" class="row">
        <el-col :span="2">
          <el-button type="primary" @click="addDialogVisible = true">Add Carousel</el-button>
        </el-col>
        <el-col :span="2">
      ...
      <!-- Carousel Information Table -->
      <el-table :data="movieList" style="width: 100%" border stripe @selection-change="handleSelectionChange">
        <el-table-column type="selection" width="55"></el-table-column>
        <el-table-column prop="carouselId" label="#" width="40"></el-table-column>
        <el-table-column prop="carouselPicture" label="Picture"></el-table-column>
        <el-table-column prop="carouselUrl" label="Duration (minutes)"></el-table-column>
        <!-- Action Buttons -->
        <el-table-column label="Action" width="240">
          <template slot-scope="scope">
            ...
            <el-tooltip effect="dark" content="Edit Carousel Information" placement="top" :enterable="false" :open-delay="500">
              <el-button type="primary" icon="el-icon-edit" size="mini" @click="isAbleEdit(scope.row.movieId)"></el-button>
            </el-tooltip>
            <el-tooltip effect="dark" content="Delete Carousel" placement="top" :enterable="false" :open-delay="500">
