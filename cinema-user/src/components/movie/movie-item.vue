<template>
  ...
  <div class="movie-item">
    <div v-on:mouseover="isHover = true" v-on:mouseleave="isHover = false">
      ...
      <!-- Effect when mouse hovers -->
      <div class="movie-item-hover" v-if="isHover">
        <!-- Poster -->
        <a :href="movieInfoUrl">
          <img class="poster-hover" :src="this.global.base + movieItem.moviePoster">
          <!-- Information displayed when mouse hovers -->
          <div class="movie-hover-info">
            <div class="title-hover">
              <span class="name-tags">{{movieItem.movieName}}</span>
            </div>
            <div class="title-hover">
              <span class="name-tags">Type: </span>{{movieItem.movieCategoryList}}
            </div>
            <div class="title-hover">
              <span class="name-tags">Release Date: </span>{{movieItem.releaseDate}}
            </div>
          </div>
        </a>
      </div>
