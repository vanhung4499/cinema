  ...
  <div>
    ...
    <div class="whole">
      <div class="left">
        <div class="panel">
          <div class="panel-header">
            <h2 style="color: #ef4238">Now Showing</h2>
            <a href="/movie/movieOngoing">All</a>
          </div>
        ...
        <div class="panel">
          <div class="panel-header">
            <h2 style="color: #2d98f3">Coming Soon</h2>
            <a href="/movie/movieUpcoming">All</a>
          </div>
          <div class="panel-content">
            <div class="panel-content">
        ...
        <div class="panel">
          <div class="panel-header">
            <h2 style="color: #ef4238">Classic Movies</h2>
            <a href="/movie/movieClassics">All</a>
          </div>
          <div class="panel-content">
            <div class="panel-content">
      ...
      <div class="right">
        <div class="panel">
          <div class="panel-header">
            <h2 style="color: #ffb400">Box Office Rankings</h2>
            <a href="/rankingList/totalBoxOfficeList">View Full List</a>
          </div>
          <div class="panel-content">
