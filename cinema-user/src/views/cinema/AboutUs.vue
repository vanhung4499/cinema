<template>
  <div>
    <div class="list-header">
      <h2 class=""><span>Cinema Information</span></h2>
    </div>
    <div class="list-content" :model="cinemaInfo">
      <div class="list-left">
        <a @click="toChooseSession(cinemaInfo.cinemaId)"><h1>{{cinemaInfo.cinemaName}}</h1></a>
        <h3 class="cinema-address">Address: {{ cinemaInfo.cinemaAddress }}</h3>
        <h3 class="cinema-address">Phone: {{ cinemaInfo.cinemaPhone }}</h3>
        <br/>
        ...
        <br/>
        <el-button @click="toChooseSession(cinemaInfo.cinemaId)" type="primary" round size="medium" align="left">Select Seat and Buy Ticket</el-button>
      </div>
