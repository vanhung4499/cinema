        ...
        <div class="movie-info-right">
          <div class="movie-info-msg">
            ...
            <ul>
              ...
              <li>{{movieInfo.movieArea}} / {{movieInfo.movieLength}} minutes</li>
              <li>{{movieInfo.releaseDate}} {{movieInfo.movieArea}} Release</li>
            </ul>
          </div>
          <div class="movie-info-btn">
            <el-button class="buy-btn" type="primary" @click="toChooseSession">Special Offer Ticket</el-button>
          </div>
          <div class="movie-info-score">
            <div class="movie-index box-office-container">
              <span class="movie-index-title">Total Box Office</span>
      ...
      <div class="movie-info-detail clearfix">
        <div class="main-content">
          <div class="crumbs-nav-container">
            <a href="/welcome">Cinema</a> &gt; <a href="/movie">Movies</a> &gt; {{movieInfo.movieName}}
          </div>
          <el-tabs v-model="activeName">
            <el-tab-pane label="Introduction" name="introduction">
              <div class="tab-body">
                ...
                <div class="module">
                  <div class="mod-title">
                    <h2>Gallery</h2>
                    <a class="more" @click="showPictures">All</a>
                  </div>
                  <div class="mod-content">
                    <div class="pictures-list">
                      <div v-if="movieInfo.moviePictures.length === 0">
                        No picture resources available
                      </div>
                      <el-image
                        class="default-img"
            ...
            <el-tab-pane label="Gallery" name="pictures">
              <div class="tab-body">
                <div class="pictures-list">
                  <div class="little-pictures">
                    <div v-if="movieInfo.moviePictures.length == 0">
